const Lsi = {
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuMeteoapp.",
      en: "You can buy your own uuMeteoapp.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuMeteoapp.",
      en: "You don't have rights to initialize this uuMeteoapp.",
    },
  },
